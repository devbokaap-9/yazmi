      ...
      <main className="main_section">
        <div className="all_user">
          <SubHeader
            checkedAll={check1}
            name="All Forms"
            count={(checkPermission('custom_form_data_get') || checkPermission('custom_form_data_created')  || checkPermission('custom_form_data_delete') || checkPermission('custom_form_data_edit')  || checkPermission('custom_form_data_all') || checkPermission('custom_form_operation_download')  || checkPermission('custom_form_operation_preview') || checkPermission('custom_form_operation_share')) ? count : 0}
            countname="forms"
            addName="User"
          />
          ...
          {(checkPermission('custom_form_data_get') || checkPermission('custom_form_data_created')  || checkPermission('custom_form_data_delete') || checkPermission('custom_form_data_edit')  || checkPermission('custom_form_data_all') || checkPermission('custom_form_operation_download')  || checkPermission('custom_form_operation_preview') || checkPermission('custom_form_operation_share'))
          ?
            <div className="data_table">
              <DataTableList check={check1} setCheck={setCheck} count={setFormCount}/>
            </div>
          :
            <></>
          }
