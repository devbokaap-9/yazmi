...
const ViewFederalUserModal = (props) => {
  const [showEditFederalUser, setShowEditFederalUser] = useState(false);

  const single_user = useSelector(
    (state) => state.federalData && state.federalData.singlefederaluserdata
  );

  const editIconClick = () => {
    setShowEditFederalUser(true);
    props.closeModal();
  };

  const closeEditFederalUserModal = () => {
    setShowEditFederalUser(false);
  };
  ...
  return (
    <>
      <Modal show={props.show} onHide={props.closeModal}>
        <Modal.Header closeButton>
          <Modal.Title>
            ...
            <Link className="edit-modal-header" onClick={editIconClick}>
              <img
              ...
              <div className="modal-form-wrapper">
                <div className="uf-single">
                  ...
                  <div className="uf-field">
                    <span className="uf-field-value">
                      {single_user &&
                        single_user.profile &&
                        single_user.profile.username}
                    </span>
                  </div>
                </div>
                <div className="uf-single">
                  ...
                  <div className="uf-field">
                    <span className="uf-field-value">
                      {single_user &&
                        single_user.profile &&
                        single_user.profile.first_name}
                    </span>
                  </div>
                </div>
                <div className="uf-single">
                  ...
                  <div className="uf-field">
                    <span className="uf-field-value">
                      {single_user &&
                        single_user.profile &&
                        single_user.profile.middle_name}
                    </span>
                  </div>
                </div>
                <div className="uf-single">
                ...
                <div className="uf-single uf-single">
                  ...
                  <div className="uf-field">
                    <span className="uf-field-value">
                      {single_user &&
                        single_user.profile &&
                        single_user.profile.citizenship}
                    </span>
                  </div>
                </div>
                <div className="uf-single uf-single">
                ...
                <div className="uf-single">
                  ...
                  <div className="uf-field">
                    <span className="uf-field-value">
                      {single_user &&
                        single_user.profile &&
                        single_user.profile.phone_number}
                    </span>
                  </div>
                </div>
              </div>
                ...
                <div className="uf-single uf-single">
                  ...
                  <div className="uf-field">
                    <span className="uf-field-value">
                      {single_user &&
                        single_user.profile &&
                        single_user.profile.region_name}
                    </span>
                  </div>
                </div>
                <div className="uf-single uf-single">
                ...
                <div className="uf-single uf-single">
                  ...
                  <div className="uf-field">
                    <span className="uf-field-value">
                      {single_user &&
                        single_user.profile &&
                        single_user.profile.woreda_name}
                    </span>
                  </div>
                </div>
                <div className="uf-single uf-single">
      ...
      {/* <EditUserModal name="Other" show={showEditFederalUser} closeModal={closeEditFederalUserModal} /> */}
    </>
  );
};
export default ViewFederalUserModal;
