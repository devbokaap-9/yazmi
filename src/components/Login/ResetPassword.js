...
const Index = (props) => {
    ...
    useEffect(() => {
        if(errorsData && errorsData.new_password2 && errorsData.new_password2.length >= 0){
            setLoading(false);
        }
                            ...
                            <Formik 
                                ...
                                <Form className="login-yazmi">
                                    ...
                                    <div className="form-group">
                                        ...
                                        <Link to="/security-questions" className="link-tertiary login-link"><span className="arrow-right">Skip</span><img src={process.env.PUBLIC_URL+'/images/skip-arrow.png'} alt=">"/><img src={process.env.PUBLIC_URL+'/images/skip-arrow.png'} alt=">" /></Link>
                                    </div>
                                </Form>
                            </Formik>
                        </div>
