...
import RoleByGroup from "./RoleByGroup";
  ...
  return (
    <>
      <main className="main_section">
        ...
        <SubHeader name="Roles" count={(checkPermission('custom_role_data_created')) || (checkPermission('custom_role_data_delete')) || (checkPermission('custom_role_data_edit')) || (checkPermission('custom_role_data_get')) || (checkPermission('custom_role_operation_share') || (checkPermission('custom_role_data_all')))
        ? count : 0} countname="Roles" addName="User"/>
        ...
        ?
          <div className="data_table">
            <RoleByGroup count={setRoleCount}/>
          </div>
        :
          <></>
        }
