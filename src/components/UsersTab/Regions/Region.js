  ...
  return (
    <>
      <main className="main_section">
        ...
        ?
          <div className="data_table" id="region_table">
            <DataTableList  check={check1} setCheck={setCheck} count={setRegionCount} />
          </div>
        :
          <></>
        }
