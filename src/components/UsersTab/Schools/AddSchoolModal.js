...
import { addSchoolData, getSchoolsData } from '../../../actions/School';
...
const AddSchoolModal = (props) => {
	...
	const saveAllData = (e) => {
		...
		dispatch(addSchoolData(save_data));
	};

	const schoolResData = useSelector(
		(state) => state.schoolData.addSchoolDataRes
	);
				...
				>
					...
					>
						<Formik
							...
							validationSchema={validationSchemaForFacilityTab}
