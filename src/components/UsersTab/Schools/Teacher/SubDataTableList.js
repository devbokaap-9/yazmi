...
const headRows = [
  { id: "name", numeric: false, disablePadding: true, label: "teacher Name 1" },
  { id: "calories", numeric: true, disablePadding: false, label: "Users" },
  { id: "fat", numeric: false,  disablePadding: false, label: "Woreda" },
  { id: "carbs", numeric: false, disablePadding: false, label: "Region" },
...
const EnhancedTable = (props) => {
  ...
  return (
                    ...
                    >
                      ...
                      <TableCell align="left">
                        <div className={props.check ? "action_icon invisible" : "action_icon"}>
                          <span className="datatable_icon delete_icon" onClick={() => {showDeleteModal(row.name)}}>
                            <svg
                              width="11"
                              height="14"
                              viewBox="0 0 11 14"
                          ...
                          <span className="datatable_icon edit_icon" onClick={showEditTeacherModal} >
                            <svg
                              width="16"
                              height="16"
                              viewBox="0 0 16 16"
    ...
    <ViewTeacherModal show={showViewSchool} closeModal={closeViewTeacherModal} />  
    <EditTeacherModal show={showEditSchool} closeModal={closeEditTeacherModal} /> 
    <DeleteModal name={userName} show={showDelete} closeModal={closeDeleteModal}  />
    </>
  );
};
